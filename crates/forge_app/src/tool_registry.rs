...
use forge_domain::{
    Agent, AttemptCompletion, Environment, FSSearch, Shell, ToolCallContext, ToolCallFull,
...
use crate::{
    ...
    NetFetchService, PatchOutput, ReadOutput, SearchResult, Services, ShellService,
};
